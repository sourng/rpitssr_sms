...
<div class="box">
	<div class="box-header">
    	...
    	<!------CONTROL TABS START------->
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#add" role="tab" data-toggle="tab">
                        <i class="icon-plus"></i><?php echo get_phrase('(A) ជីវប្រវត្តិសិស្ស');?>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#add1" role="tab" data-toggle="tab">
                        <i class="icon-plus"></i><?php echo get_phrase('(C) កម្មវិធី-វគ្គបណ្តុះបណ្តាល');?>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#add2" role="tab" data-toggle="tab">
                         <i class="icon-plus"></i><?php echo get_phrase('(D) ព័ត៌មានការងារ');?>
                    </a>
                </li>
            </ul>
        <!------CONTROL TABS END------->
	...
	<div class="tab-content">
        ...
        <!-- CREATION FORM STARTS2 -->
        <div role="tabpanel" class="tab-pane fade" id="add1">
            <div class="tab-pane box" style="padding: 5px">
                <div class="box-content">
