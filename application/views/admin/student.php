...
<div class="box">
    	...
    	<!------CONTROL TABS START------->
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item active" >
                    ...
                    <i class="icon-align-justify"></i><?php echo get_phrase('student_list');?>
                    	</a>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#adddd" role="tab" data-toggle="tab">
                        <i class="icon-plus"></i><?php echo get_phrase('Add Student');?>
                    </a>
                </li>
            </ul>
        <!------CONTROL TABS END------->
	...
	<div class="tab-content">
      				...
      				<div class="box-content">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="span1"><?php echo $row['stu_id'];?></td>
                                    <td>
                                    ...
                                    <td><?php echo $row['txt_family_kh'].' '. $row['txt_first_kh'];?><br/><?php echo $row['txt_family_en'].' '.$row['txt_first_en'];?></td>
                                    <td><?php echo $row['txt_birth_place'];?></td>
                                    <td><?php echo $row['txt_parent_phone'];?><br/><?php echo $row['txt_parent_email'];?></td>
                                    <td align="center" class="span5">
                                        
                                        
                                        <a  data-toggle="modal" href="#modal-form" onclick="modal('student_profile',<?php echo $row['stu_id'];?>)" class="btn btn-default btn-small">
                                            <i class="icon-user"></i> <?php echo get_phrase('profile');?>
                                        </a>
                                        <!-- <a  data-toggle="modal" href="#modal-form" onclick="modal('student_academic_result',<?php echo $row['stu_id'];?>)" class="btn btn-default btn-small">
                                            <i class="icon-file-alt"></i> <?php echo get_phrase('marksheet');?>
                                        </a> -->
                                        <a  data-toggle="modal" href="#modal-form" onclick="modal('student_id_card',<?php echo $row['stu_id'];?>)" class="btn btn-default btn-small">
                                        ...
                                        <a  data-toggle="modal" href="#modal-form" onclick="modal('edit_student',<?php echo $row['stu_id'];?>,<?php echo $class_id;?>)" class="btn btn-gray btn-small">
        ...
        <div role="tabpanel" class="tab-pane fade" id="adddd">
            <!------CONTROL TABS START------->
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item active" >
                        <a class="nav-link active" href="#add1" id="tab-add1" role="tab" data-toggle="tab">
                        <i class="icon-plus"></i><?php echo get_phrase('(A)ជីវប្រវត្តិ');?>
                            </a>
                        </a>
                    </li>
                    <li class="nav-item" >
                        <a class="nav-link" href="#add2" id="tab-add2" role="tab" data-toggle="tab">
                        <i class="icon-plus"></i><?php echo get_phrase('(B)កម្មវិធី៌-វគ្គបណ្តុះបណ្តាល');?>
                            </a>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#add3" id="tab-add3" role="tab" data-toggle="tab">
                            <i class="icon-plus"></i><?php echo get_phrase('(C)ព័ត៌មានការងារ');?>
                        </a>
                    </li>
                </ul>
            <!------CONTROL TABS END------->
            ...
            <div role="tabpanel" class="tab-pane fade in active" id="1">
                <div class="tab-pane box" style="padding: 5px">
                    <div class="box-content">
                            <?php echo form_open('admin/student/create/' , array('id'=>'form_add_student','class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data'));?>
                                <div class="padded">
                                    <div class="tab-content">
                                        <!-- Tap 3 -->
                                        <div role="tabpanel" class="tab-pane fade in active" id="add1">                        
                                                ...
                                                <div class="form-actions" >
                                                    ...
                                                    <a class="btn btn-success" href="javascript:(0)" onclick="tab('add2')">Next</a>
                                                    </div>
                                                </div>
                                        </div>
                                        <!-- Tap 3 -->
                                        <!-- Tap 1 -->
                                        <div role="tabpanel" class="tab-pane fade" id="add2">                                                                                  
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                    <table id="row_insert">
                                                                        ...
                                                                        <tr id="delete_0" class="row_delete">
                                                                            ...
                                                                            <td>
                                                                               <a id="add_row" class="btn btn-success">Add</a>
                                                                               <a id="delete_row" data-remove="0" class="btn btn-danger">Delete</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>                                  
                                                            </tr> 
                                                ...
                                                <div class="form-actions" >
                                                    <div class="row">                                
                                                        <div class="col-md-2 pull-left" >
                                                            <a class="btn btn-success" href="javascript:(0)" onclick="tab('add1')">Back</a>
                                                        </div>                                                        
                                                        <div class="col-md-2 pull-right">
                                                            <a class="btn btn-success" href="javascript:(0)" onclick="tab('add3')">Next</a>
                                                        </div>
                                                    </div>
                                                </div>      
                                        ...
                                        <!-- Tap 2 -->
                                        <div role="tabpanel" class="tab-pane fade" id="add3">                                                    
                                                        <table>                                        
                                                            <tr>
                                                                <table>
                                                ...
                                                <div class="form-actions" >
                                                    <div class="row">                                
                                                        <div class="col-md-2 pull-left" >
                                                            <a class="btn btn-success" href="javascript:(0)" onclick="tab('add2')">Back</a>
                                                        </div>                                                        
                                                        <div class="col-md-2 pull-right">                                                        
                                                            <a id="btn_add_student" type="submit" class="btn btn-gray"><?php echo get_phrase('add_student');?></a>                                                
                                                        </div>
                                                    </div>
                                                </div> 
...
<script>
    ...
    $(document).on("click","#add_row",function(){
        i++;
        $("#row_insert").append('<tr id="delete_'+i+'" class="row_delete"><td><input type="text" name="txt_coursename[]" style="width: 140px"></td><td><select name="cbo_istvet[]" class="uniform" style="width:100%;"><option value="0"><?php echo get_phrase('ទេ');?></option><option value="1"><?php echo get_phrase('បាទ/ចាស');?></option></select></td><td><select name="cbo_program_type[]" class="uniform" ​ style="width:100%;"><option value="0">ជ្រើសខាងក្រោម៖ </option><option value="1">វគ្គខ្លី</option><option value="2">ស.ប.វិ ១</option><option value="3">ស.ប.វិ ២</option><option value="4">ស.ប.វិ ៣</option><option value="5">សញ្ញាបត្រជាន់ខ្ពស់បច្ចេកទេស</option><option value="6">បរិញ្ញាបត្រ / វិស្វករ</option><option value="7">អនុបណ្ឌិត</option><option value="8">បណ្ឌិត</option></select></td><td><input type="text" name="txt_course_year[]"​ style="width: 60px"></td><td><input type="text" name="txt_school_name[]" style="width: 140px"></td><td><input type="text" name="txt_school_location[]" style="width: 140px"></td><td><td><a id="add_row" class="btn btn-success">Add</a><a id="delete_row" data-remove="'+i+'" class="btn btn-danger">Delete</a></td></tr>');
    ...
    $(document).on("click","#delete_row",function(){
        ...
        var count_row=$(".row_delete").length;
        if(count_row>1){
            $("#delete_"+remove_id).remove();
        }else{
            alert("Cant Delete"); 
        }
