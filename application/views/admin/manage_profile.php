...
<?php echo get_phrase('  ::::::Please you cant change the password because other person are testing it its not a demo it the real version Good Test');?>
                    ...
                    foreach($edit_data as $row):
                        ...
                        <?php echo form_open('admin/manage_profile/update_profile_info' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                            ...
                            <div class="form-actions">
                                <butto type="submit" class="btn btn-gray"><?php echo get_phrase('update_profile');?></butto>
                            </div>
                        </form>
						<?php
                    endforeach;
                ...
                <div class="box-content padded">
                    ...
                    foreach($edit_data as $row):
                        ...
                        <?php echo form_open('admin/manage_profile/change_password' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                            ...
                            <div class="form-actions">
                                <butto type="submit" class="btn btn-gray"><?php echo get_phrase('update_password');?></butto>
                            </div>
                        </form>
						<?php
                    endforeach;
