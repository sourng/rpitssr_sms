				...
				<?php foreach($edit_data as $row):?>
                	<?php echo form_open('admin/student/'.$class_id.'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal validatable','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Khmer Name');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="khname" value="<?php echo $row['khname'];?>"/>
                                </div>
                            </div>
				<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('latine name');?></label>
                                <div class="controls">
