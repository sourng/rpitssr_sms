...
class Enroll extends CI_Controller
{
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = get_phrase('enroll_dashboard');
    ...
    /****MANAGE TEACHERS*****/
    function enroll_list($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('enroll_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($param1 == 'personal_profile') {
            $page_data['personal_profile']   = true;
            $page_data['current_enroll_id'] = $param2;
        }
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'teacher';
        $page_data['page_title'] = get_phrase('enroll_list');
        $this->load->view('index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
            $data['enroll_id'] = $this->input->post('enroll_id');
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $this->db->where('enroll_id', $this->session->userdata('enroll_id'));
