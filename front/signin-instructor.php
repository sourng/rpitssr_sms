...
<?php
    ...
    if(isset($_POST['btnSignin'])){
        if($_POST['btnSignin']=='signin1'){
            ...
            header('Location: dashboard.php?login='.$user_type); 
            // echo "Hello, " . $user;

            }else{
                 // header('Location: /directory/mypage.php'); 
            header('Location: signin-instructor.php'); 
            // echo "Hello, " . $user;
            }
            ...
            <div class="row" style="margin-bottom: 23px;">
                <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3" style="background-color: gray;padding: 0px 5px 15px 5px">
                    <form role="form" method="post">
                        ...
                        <hr class="colorgraph">
                        <div class="row">
                            <div class="col-xs-12 col-md-6" style="color: white; font-size: 17px;">If you don't have an Account please, <a class="btn btn-default" href="become-instructor.php" style="color:tomato;">Click here!</a></div>
                            <div class="col-xs-12 col-md-6">
                                <!-- <input  class="btn btn-success btn-block btn-lg" type="submit" valule="Signin" name="btnSignin"> -->
                                <button class="btn btn-success btn-block btn-lg" type="submit" name="btnSignin" value="signin1">Signin</button>
